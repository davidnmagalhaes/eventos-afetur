...
<html lang="pt-br">
   <head>
       <meta charset="utf-8"/>
       <title>Financeiro - Afetur Eventos</title>
   ...
   <body>
	...
	<div class="container content" style="min-height: 780px;">
			<h3 style="margin-top: 20px;"><i class="fas fa-search-dollar"></i> Financeiro</h3>
			<div class="row">
				...
				<div class="col">
					<table class="table">
					  ...
					  <?php  while ($row_eventos = mysqli_fetch_array($eventos)){ ?>
						<tr>
						  <td style="text-align:center;"><?php echo $row_eventos['nome_evento']; ?></td>
						  <td style="text-align:center;"><a href="relatorio-fin.php?ref=<?php echo $row_eventos['ref'];?>"><i class="fas fa-eye"></i></a></td>
