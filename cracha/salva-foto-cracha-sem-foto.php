...
$img = $_POST['image'];
	...
	$result_usuario = "UPDATE evn_inscritos SET imagem = '$fileName' WHERE id_inscritos='$idinscrito';";
	
	if ($link->multi_query($result_usuario) === TRUE) {
		 file_put_contents($file, $image_base64);
		 header("Location: imprimir-cracha-sem-foto.php?id_inscritos=".$idinscrito."&ref=".$ref);
	} else {
