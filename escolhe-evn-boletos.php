...
<html lang="pt-br">
   ...
   <body>
	...
	<div class="container content" style="min-height: 780px;">
			<h3 style="margin-top: 20px;"><i class="fas fa-barcode"></i> Escolha um evento</h3>
			<div class="row">
					...
					<table class="table">
					  ...
					  <?php while ($row_eventos = mysqli_fetch_array($eventos)){ ?>
						<tr>
						  ...
						  <td align="center"><a href="listar-boletos.php?ref=<?php echo $row_eventos['ref'];?>"><i class="fas fa-eye"></i></a></td>
						</tr>
						<?php } ?>
					  </tbody>
					</table>
