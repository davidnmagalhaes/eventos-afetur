...
<body style="background: #afb2c1;">
	...
	<form id="comprar" name="comprar" method="post"
		action="teste-pagseguro/source/examples/checkout/createPaymentRequest.php">
							...
							<tr>
								...
								<td>
									...
									<input type="number" id="quantidade" name="quantidade[]"
										class="form-control name_list ing add" onchange="calculaPg();exibePagamento()"
								...
								<input name="unidadeingresso[]" type="hidden" id="unidadeingresso"
									value="<?php echo $row_ingressos['unidade']; ?>">
							...
							<tr>
								...
								<td>
									...
									<input type="email" id="email" name="email[]"
										placeholder="E-mail do participante principal"
										onkeyup="javascript: doSomething(this)" class="form-control name_list"
										required />
								</td>
			...
			<div class="row" style="width: 100%; margin: 20px auto;">
				<div class="col-12" style="display: flex; justify-content: center;">
					...
					<button style='display: none;margin-right: 15px;' type='submit' id='inscreverboleto'
						onclick='return blu();' class='btn btn-primary btn-lg'><i class="fas fa-barcode"
							style='margin-right:5px;'></i> BOLETO E PIX</button>
					<button style='display:none; margin-right: 20px;' type='submit' id='inscrevercartao'
						onclick='return bla();' class='btn btn-primary btn-lg'><i class='fas fa-credit-card'
							style='margin-right:5px;'></i> CART&Atilde;O DE CR&Eacute;DITO</button>
					<button style='display: none; margin-right: 20px;' type='submit' id='inscrevergratis'
						onclick='return gratis();' class='btn btn-primary btn-lg'>Finalizar
						Inscri&ccedil;&atilde;o</button>
					<button style='display: none;margin-right: 20px;' type='submit' id='inscreverpaypal'
						onclick='return paypal();' class='btn btn-primary btn-lg'><i class='fab fa-paypal'
							style='margin-right:5px;'></i> Pagar com Paypal</button>
				</div>
