...
<script id="ze-snippet" src="https://static.zdassets.com/ekr/snippet.js?key=e23888b5-e3fb-40d9-a632-223524f07989"> </script>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown" style="height: 65px;">
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown" style="width: 115px;">
		...
		<a class="dropdown-item" href="escolhe-evento-pedido.php">Pagos</a>
          <a class="dropdown-item" href="escolhe-evento-pedido-pendente.php">Pendentes</a>
	  ...
	  <?php } ?>
	  <?php if($_SESSION['nivel'] == 2 || $_SESSION['nivel'] == 3 || $_SESSION['nivel'] == 4){?>
	  <li class="nav-item dropdown" style="width: 115px;">
		<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Financeiro
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
		<a class="dropdown-item" href="../financeiro.php">Ver financeiro</a>
		<?php if($_SESSION['nivel'] == 3){?>
          <a class="dropdown-item" href="../escolhe-evn-boletos.php">Boletos</a>
		   <?php } ?>
          
        </div>
      </li>
	  <?php } ?>
	  <?php if($_SESSION['nivel'] == 1 || $_SESSION['nivel'] == 3 || $_SESSION['nivel'] == 4){?>
	  <li class="nav-item dropdown" style="width: 115px;">
		<a class="nav-link dropdown-toggle" href="inscritos.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Marketing
        </a>
