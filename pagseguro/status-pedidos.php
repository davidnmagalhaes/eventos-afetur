					...
					<table class="table">
					  ...
					  <?php do { ?>
						<tr>
						  ...
						  <?php if($row_eventos['id'] != 1 || $row_eventos['id'] != 2 || $row_eventos['id'] != 3 || $row_eventos['id'] != 4 || $row_eventos['id'] != 5 || $row_eventos['id'] != 6 || $row_eventos['id'] != 7 || $row_eventos['id'] != 8 || $row_eventos['id'] != 9 || $row_eventos['id'] != 10 || $row_eventos['id'] != 11 || $row_eventos['id'] != 12 || $row_eventos['id'] != 14){echo "<td align='center'>Não pode ser <strong>editado!</strong></td><td align='center'>Não pode ser <strong>excluído!</strong></td>";}else{?>
						  ...
						  <td style="text-align:center;"><a title="Excluir status" href="exc-status.php?id=<?php echo $row_eventos['id'];?>&nme=<?php echo $_SESSION['nome'];?>" class="remove"><i class="fas fa-trash-alt"></i></a></td>
						  <?php }?>
						</tr>
