...
$result_curso = "SELECT * FROM evn_pedidos WHERE status != 3 && status != 12 && ref='$ref'";
 ...
 <div class="row">
			...
			<nav class="text-center">
				<ul class="pagination justify-content-center">
						...
						<li class="page-item">
							<a class="page-link" href="pedidos-pendentes.php?ref=<?php echo $ref;?>&pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
					...
					for($i = 1; $i < 5 + 1; $i++){ ?>
						<li class="page-item"><a class="page-link" href="pedidos-pendentes.php?ref=<?php echo $ref;?>&pagina=<?php echo $i; ?>"><?php echo $i; ?></a></li>
					<?php } ?>
					
						<?php
						if($pagina_posterior <= $num_pagina){ ?>
						<li class="page-item">
							<a class="page-link" href="pedidos-pendentes.php?ref=<?php echo $ref;?>&pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
