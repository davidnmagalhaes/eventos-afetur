...
<html lang="pt-br">
   ...
   <body>
	...
	<div class="container content" style="min-height: 780px;">
			<h3 style="margin-top:20px;"><i class="fas fa-cash-register"></i> Pedidos Pendentes</h3>
			<div class="alert alert-primary" role="alert">
				Escolha o evento que deseja ver os <strong>pagamentos pendentes</strong>.
			</div>
			<div class="row">
				<div class="col">
					<table class="table">
					  ...
					  <?php while($row_eventos = mysqli_fetch_array($eventos)){ ?>
						<tr>
						  ...
						  <td align="center"><a href="pedidos-pendentes.php?ref=<?php echo $row_eventos['ref'];?>"><i class="fas fa-eye"></i></a></td>
