...
$tabela .= '<tr>';
$tabela .= '<td colspan="6" align="center">Relat&oacute;rio Financeiro </tr>';
$tabela .= '</tr>';
$tabela .= '<tr>';
...
$tabela .= '<td align="center"><b>Data do pagamento</b></td>';
...
$resultado = mysqli_query($link, 'SELECT * FROM evn_pedidos WHERE ref='.$ref.' AND status = 3 ORDER BY data_pagamento ASC');
...
$tabela .= '<td align="center">'.$dados['data_pagamento'].'</td>';
