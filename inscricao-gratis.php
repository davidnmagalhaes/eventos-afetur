...
if (!$captcha_data):
	...
	if ($resposta.success):
		...
		$cod = $row_eventos['id'];
		$cod += 1;
		$tipotransacao = "Inscrição Gratuita";
		...
		$sql = "INSERT INTO evn_pedidos (descricao, status, nome, email, total_pedido, evento, ref, data_pedido, campo_adicional, npedido, tipo_transacao, moeda) VALUES ('Pedido #', 3, '$nome[0]', '$email[0]', '$number', '$evento', '$ref', NOW(), '$campoadicional[0]', '$npedido', '$tipotransacao', '$moeda');";
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="evento_single.php?ref=<?php echo $ref;?>" class="btn btn-success btn-block">Voltar para o evento</a>
			</div>
		</div>
	</div>
</div>     
