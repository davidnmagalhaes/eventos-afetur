...
$('.image-upload-wrap').bind('dragover', function () {
   ...
   <body>
	...
	<div class="container content">
			<form name="cdeventos" id="cdeventos" method="post" enctype="multipart/form-data" action="proc-edt-logo.php">
				...
				<h3 class="mg-top">Editando logo do evento #<?php echo $row_editaevento['ref'];?> | <?php echo $row_editaevento['nome_evento'];?></h3>
				<div class="row">
				<div class="col">
