	...
	<div class="container content">
			<form name="cdeventos" id="cdeventos" method="post" enctype="multipart/form-data" action="proc_edt_eventos.php">
				...
				<div class="row">
					...
					<div class="col">
						<label for="nomedolocal">Modalidade p/ boleto:</label>
						<input type="number" min="1" max="400" class="form-control" id="days_due_date" name="days_due_date" value="<?php echo $row_editaevento['days_due_date']; ?>"/>
					</div>
					</div>
