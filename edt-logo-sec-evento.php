...
<html lang="pt-br">
   <head>
       <meta charset="utf-8"/>
       <title>Editar Logo do Evento - Afetur Eventos</title>
...
$('.image-upload-wrap').bind('dragover', function () {
   ...
   <body>
	...
	<div class="container content">
			<form name="cdeventos" id="cdeventos" method="post" enctype="multipart/form-data" action="proc-edt-logo-secundario.php">
				...
				<h3 class="mg-top">Editando logo secundário do evento #<?php echo $row_editaevento['ref'];?> | <?php echo $row_editaevento['nome_evento'];?></h3>
				<div class="row">
				<div class="col">
...
<div class="file-upload">
  <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">Adicionar logo secundário ao evento</button>

  <div class="image-upload-wrap">
    <input class="file-upload-input" id="logo" name="logo" type='file' onchange="readURL(this);" accept="image/*" />
    <div class="drag-text">
