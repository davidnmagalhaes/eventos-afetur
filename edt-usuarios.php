...
<html lang="pt-br">
   <head>
       <meta charset="utf-8"/>
       <title>Atualização de Usuários - Afetur Eventos</title>
   ...
   <body>
	...
	<div class="container content">
			<form method="post" enctype="multipart/form-data" action="login-seguro/proc_cd_usuario.php">
				...
				<h3 class="mg-top" style="margin: 20px 0;"><i class="fas fa-user" style="margin: 0 10px"></i> Atualização de Usuários</h3>
				<div class="row">
				<div class="col">
