...
<html lang="pt-br">
   ...
   <body>
	...
	<div class="container content" style="min-height: 780px;">
			<h3 style="margin-top: 20px;"><i class="far fa-lightbulb"></i> Escolha um evento</h3>
			<div class="row">
					...
					<table class="table">
					  <thead class="thead-dark">
						<tr>
						  ...
						  <th scope="col" style="text-align:center;"><i class="fas fa-check-circle"></i></th>
						</tr>
					  </thead>
					  <tbody>
					  <?php while ($row_eventos = mysqli_fetch_array($eventos)) { ?>
						<tr>
						  ...
						  <td align="center"><a href="email-marketing.php?ref=<?php echo $row_eventos['ref'];?>"><i class="fas fa-check-circle"></i></a></td>
						</tr>
						<?php } ?>
					  </tbody>
					</table>
